        ...
        <div class="container " style="min-height: 581px;">
            <div class="content">
                ...
                <div class="order-related">
                    ...
                    <div class="block block-list list-vertical">
                        <router-link to="/address" class="block-item link clearfix ico-setting js-login" href="https://h5.youzan.com/v2/buyer/member/setting" target="_self">
                            <p class="title-info c-black font-size-14">收获地址管理</p>
                        </router-link>
                        <a class="block-item link clearfix ico-help"  target="_self">
...
<script>
    ...
    import '../assets/css/member_base.css';
    export default {
        name:'member'
    }
</script>
